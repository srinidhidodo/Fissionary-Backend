...
def simulate(locationPlaces):
	for locationPlace in locationPlaces:
		heatmap = HeatMap()
		crowd = CrowdSimulator(heatmap, 100,100)
		simulator = crowd.getCrowdSimulator(saveImage=True, imageName='l%s_p%s' % (locationPlace[0], locationPlace[1]))
